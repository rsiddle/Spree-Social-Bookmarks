...
desc 'Generate documentation for the social_bookmarks extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'SocialBookmarksExtension'
...
desc 'Test the social_bookmarks extension.'
...
namespace :test do
  desc 'Functional test the social_bookmarks extension.'
  ...
  desc 'Unit test the social_bookmarks extension.'
